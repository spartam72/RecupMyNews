...
import com.example.spart.recupmynews.Controller.DetailActivitySports;
...
public class SportsAdapter extends RecyclerView.Adapter<SportsAdapter.MyViewHolder> {
    ...
    private final ArrayList<ArticleSport> results;

    public SportsAdapter(Context context, ArrayList<ArticleSport> results) {
      ...
      //  holder.mPublishedDate.setTextColor(  ContextCompat.getColor(context,R.color.colorSport ) );
        ...
        holder.articleItemWindow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), DetailActivitySports.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                ArticleSport newsData=results.get(position);
